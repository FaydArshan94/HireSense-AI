...
export default function AnalysisDetailPage() {
    ...
    const { matchScore, matchedSkills, missingSkills, suggestions } = analysisResult;
                    ...
                    <Card className="bg-card/80 backdrop-blur-sm border-border shadow-xl">
                        <CardContent className="p-6 space-y-4">
                            <div className="flex items-start justify-between">
                                ...
                                <Button
                                    onClick={() => router.push("/dashboard")}
                                    className="px-6 py-6 text-base font-medium bg-primary hover:bg-primary/90 transition-all hover:shadow-lg hover:scale-105 group"
                                >
                                    <RefreshCw className="mr-2 w-5 h-5 group-hover:rotate-180 transition-transform duration-500" />
                                    Re-analyze with Improved Resume
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <div className="space-y-8">
                    ...
                    <div className="relative bg-card border border-border rounded-2xl shadow-2xl p-8 overflow-hidden">
                        ...
                        <div className="relative space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className={`text-7xl font-bold ${getScoreColor(matchScore)}`}>
                                    {matchScore}%
                                </div>
