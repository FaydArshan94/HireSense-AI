...
export default function HeroSection() {
    ...
    return (
        <section
            ref={heroRef}
            className="relative min-h-screen flex items-center pt-20 lg:pt-0 bg-gradient-to-b from-background to-muted/20"
        >
                        ...
                        <div className="relative bg-card border border-border rounded-2xl shadow-2xl p-8 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <div className="text-5xl font-bold text-foreground">85/100</div>
                            ...
                            <div className="space-y-3 pt-4 border-t border-border">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-sm font-semibold text-foreground">40/50</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-sm text-muted-foreground">Content</span>
                                    <span className="text-sm font-semibold text-foreground">25/25</span>
                                </div>
                            </div>
