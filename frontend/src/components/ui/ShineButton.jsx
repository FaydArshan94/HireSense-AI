...
const ShineButton = () => {
    return (
        <button
            className=" relative px-6 py-2 bg-zinc-800 mb-10 rounded-lg border border-zinc-700 shadow-[0_4px_14px_0_rgba(0,0,0,0.5)] flex items-center justify-center cursor-pointer overflow-hidden">
            <motion.span
